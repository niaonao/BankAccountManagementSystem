...
<h2 class="contentTitle">修改密码- 输入卡号和旧密码</h2>
<div class="pageContent">
	<form method="post" action="${ctx}/sys/add2Password2.action" class="pageForm required-validate" enctype="multipart/form-data" onsubmit="return navTabSearch(this);">
