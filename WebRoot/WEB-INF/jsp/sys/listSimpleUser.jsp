...
<div class="pageHeader">
	...
	<div class="searchBar">
		<ul class="searchContent">
			<li>
				<label>账户：</label>
				<input type="text" name="s_user.uname" value=""/>
			</li>
			<li>
				<label>姓名：</label>
...
<div class="pageContent">
	...
	<div class="panelBar">
		...
		<div class="pagination" targetType="navTab" totalCount="${SESSION_PAGE.totalNumber}" numPerPage="${SESSION_PAGE.itemsPerPage}" pageNumShown="3" currentPage="${SESSION_PAGE.currentPageNumber}"></div>
	</div>
</div>
